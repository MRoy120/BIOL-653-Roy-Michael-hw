...
##Question 1 
###Print each value of this matrix
...
##Question 3a
###Print these values as part of a string that looks something like 'n = 16'
###Try to describe in words how creating the vector of numbers that you are going to use
